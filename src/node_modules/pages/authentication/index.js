...
import BackendErrorMessage from 'pages/authentication/components/backendErrorMessages'
...
const Authentication = (props) => {
    ...
    // we can consider this as [state, setState] passed from current user context so we can access users state and also set its state 
